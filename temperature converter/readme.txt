...
**Priyanshu Sharma** - Backend Developer (Admin) 
...
1. Clone the project repository from the GitHub repository link provided.
2. Ensure that you have a compatible web server environment set up (such as Apache or Nginx) with PHP support.
...
5. You should see the temperature converter interface designed by Manan.
6. Enter a temperature value and select the input and output temperature units.
7. Click the conversion button to trigger the conversion process.

**Contact Information:**
For any inquiries or assistance regarding the project, please contact the respective team members:

- **Priyanshu Sharma**: [serjoramos4444@gmail.com]
- **Niraj Shrestha**: [neupanemanan.2003@gmail.com]
- **Manan Neupane**: [nirojs022@gmail.com]
